...
namespace DroneBlockSystem.NetworkProtobuf
{
    ...
    public class Networking
    {
        ...
        internal void ReceivedPacket(byte[] rawData) // executed when a packet is received on this machine
        {
            try
            {
        ...
        /// Only works server side.
        /// </summary>
        internal void RelayToClients(PacketBase packet, byte[] rawData = null)
        {
            if (!MyAPIGateway.Multiplayer.IsServer)
                return;
